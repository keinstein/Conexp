...
import conexp.core.bitset.BitSet2;
...
public class BitSet2Test extends TestCase {
    ...
    protected void setUp() {
        twoWordSet = new BitSet2(96);
        fillFromStart(twoWordSet, 65);
        emptySet = new BitSet2(96);

        firstWord = new BitSet2(96);
        for (int i = 0; i < 32; i++) {
            firstWord.put(i);
        }
        secondWord = new BitSet2(96);
        for (int i = 64; i < 96; i++) {
            secondWord.put(i);
        }
